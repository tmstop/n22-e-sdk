...
void  MPU6050_newValues(__int16_t ax,__int16_t ay,__int16_t az,__int16_t gx,__int16_t gy,__int16_t gz)
{
unsigned char i ;
__int32_t sum=0;
for(i=1;i<10;i++){	//FIFO ����
...
*******************************************************************************/
void MPU6050_setClockSource(__uint8_t source){
 ...
 */
void MPU6050_setFullScaleGyroRange(__uint8_t range) {
...
*��������:	    ����  MPU6050 ���ٶȼƵ��������
*******************************************************************************/
void MPU6050_setFullScaleAccelRange(__uint8_t range) {
...
*��������:	    ����  MPU6050 �Ƿ����˯��ģʽ
			    ...
			    enabled =0   ����
*******************************************************************************/
void MPU6050_setSleepEnabled(__uint8_t enabled) {
...
*******************************************************************************/
__uint8_t MPU6050_getDeviceID(void) {
...
*��������:	    ���MPU6050 �Ƿ��Ѿ�����
*******************************************************************************/
__uint8_t MPU6050_testConnection(void) {
...
*******************************************************************************/
void MPU6050_setI2CMasterModeEnabled(__uint8_t enabled) {
...
*��������:	    ���� MPU6050 �Ƿ�ΪAUX I2C�ߵ�����
*******************************************************************************/
void MPU6050_setI2CBypassEnabled(__uint8_t enabled) {
